      ...
      <div className="mb-16">
        ...
        <div className="relative -mt-12 flex flex-col md:flex-row justify-center gap-8 px-4">
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 w-full max-w-md">
            <h2 className="text-2xl font-bold mb-4 dark:text-black">Advertise on Car Traders</h2>
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 w-full max-w-md">
            <h2 className="text-2xl font-bold mb-4 dark:text-black">Sell fast for free</h2>
            <ul className="list-disc list-inside text-gray-700 mb-6">
